...
in the C implementation of Python](../pep-0007/ "PEP 7 – Style Guide for C Code").

This document and [PEP 257](../pep-0257/ "PEP 257 – Docstring Conventions") (Docstring Conventions) were adapted from
Guido’s original Python Style Guide essay, with some additions from
Barry’s style guide [[2]](#id6).
...
displayed formulas always break before binary operations” [[3]](#id7).
...
consistent with the docstring convention in [PEP 257](../pep-0257/ "PEP 257 – Docstring Conventions").
...
(a.k.a. “docstrings”) are immortalized in [PEP 257](../pep-0257/ "PEP 257 – Docstring Conventions").
...
- [PEP 257](../pep-0257/ "PEP 257 – Docstring Conventions") describes good docstring conventions. Note that most
...
- `CapitalizedWords` (or CapWords, or CamelCase – so named because
  of the bumpy look of its letters [[4]](#id8)). This is also sometimes known
  as StudlyCaps.
...
- When implementing ordering operations with rich comparisons, it is
  ...
  [PEP 207](../pep-0207/ "PEP 207 – Rich Comparisons") indicates that reflexivity rules *are* assumed by Python.
...
- Derive exceptions from `Exception` rather than `BaseException`.
  ...
  *catching* the exceptions is likely to need, rather than the locations
  ...
  “A problem occurred” (see [PEP 3151](../pep-3151/ "PEP 3151 – Reworking the OS and IO exception hierarchy") for an example of this lesson being
...
With the acceptance of [PEP 484](../pep-0484/ "PEP 484 – Type Hints"), the style rules for function
annotations have changed.

- Function annotations should use [PEP 484](../pep-0484/ "PEP 484 – Type Hints") syntax (there are some
...
- However, outside the stdlib, experiments within the rules of [PEP 484](../pep-0484/ "PEP 484 – Type Hints")
  are now encouraged. For example, marking up a large third party
  library or application with [PEP 484](../pep-0484/ "PEP 484 – Type Hints") style type annotations,
...
- For code that wants to make a different use of function annotations
  ...
  type checkers can be found in [PEP 484](../pep-0484/ "PEP 484 – Type Hints").)
...
- Users who don’t want to use type checkers are free to ignore them.
  ...
  [PEP 484](../pep-0484/ "PEP 484 – Type Hints") recommends the use of stub files: .pyi files that are read
  ...
  the library author’s permission) through the typeshed repo [[5]](#id9).

### [Variable Annotations](#variable-annotations)

[PEP 526](../pep-0526/ "PEP 526 – Syntax for Variable Annotations") introduced variable annotations. The style recommendations for them are
...
- If an assignment has a right hand side, then the equality sign should have
  ...
  ```
- Although the [PEP 526](../pep-0526/ "PEP 526 – Syntax for Variable Annotations") is accepted for Python 3.6, the variable annotation
  syntax is the preferred syntax for stub files on all versions of Python
  (see [PEP 484](../pep-0484/ "PEP 484 – Type Hints") for details).
